...
DC_URL=https://api.cluster-kmfzs.kmfzs.sandbox1264.opentlc.com:6443
DC_UID=admin
DC_PWD=8kCP7liqn8US23N9
...
AWS_URL=https://api.cluster-vcggs.vcggs.sandbox1838.opentlc.com:6443
AWS_UID=admin
AWS_PWD=XHt1jsvoLv7rMpUf
AWS_TOKEN=
...
echo "           (o o)              ┗   ┗┛┣┛┗ ┛┗  ┛┗┗┫┗┛┛ ┗┗┻  ┗┛┗┗┛┗┻┗┻   ┛"
echo " ┏━━━━━━oOO.{-}.OOo━━━━━━━━━━━━━━━━━┛━━━━━━━━━━┛━━━━┳━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[ Scope ]━━┓"
echo " ┃      ╦═╗╔═╗╔╦╗  ╦ ╦╔═╗╔╦╗                        ┃   Creating a common fabic to deliver resilient   ┃"
echo " ┃      ╠╦╝║╣  ║║  ╠═╣╠═╣ ║                         ┃   national services with seamless experience     ┃"
echo " ┃      ╩╚═╚═╝═╩╝  ╩ ╩╩ ╩ ╩                         ┃   acrross all infrastrucutre providers.          ┃"
echo " ┣━━━━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━━━━━╋━━━━━━━━━━━━━━━━━━━━━╋━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫"
echo " ┃  ┳┓┏┓                  ┃  ┏┓┓ ┏┏┓                ┃  ┏┓┏┓┳┳┳┓┏┓         ┃  ┏┓┏┓┳┳┳┓┏┓  ┳┓┏┓┏┳┓┳┓┏┏┓  ┃"
echo " ┃  ┃┃┃                   ┃  ┣┫┃┃┃┗┓                ┃  ┣┫┏┛┃┃┣┫┣          ┃  ┣┫┏┛┃┃┣┫┣   ┃┃┣┫ ┃ ┃┃┃┣   ┃"
echo " ┃  ┻┛┗┛                  ┃  ┛┗┗┻┛┗┛                ┃  ┛┗┗┛┗┛┛┗┗┛         ┃  ┛┗┗┛┗┛┛┗┗┛  ┛┗┛┗ ┻ ┻┗┛┗┛  ┃"
...
# Make sure you remove local svc for postgresql and fixed-wing-apis
oc login --server=$DC_URL -u $DC_UID -p $DC_PWD --insecure-skip-tls-verify=true
oc project $PROJECT
skupper service create postgresql 5432 --protocol tcp
skupper service create fixed-wing-apis 8080 --protocol http
;;
